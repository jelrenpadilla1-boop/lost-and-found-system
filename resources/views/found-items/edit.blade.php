...
<div class="edit-page-wrapper">
    <div class="page-header">
        <div class="page-title">
            <h1>
                <i class="fas fa-edit" style="color: var(--primary);"></i> Edit Found Item
            </h1>
            <p>Update item details</p>
        </div>
        <div class="page-actions">
            <a href="{{ route('found-items.show', $foundItem) }}" class="btn-outline-pink">
                        ...
                        <div class="form-sections">
                            ...
                            <div class="form-actions">
                                ...
                                <div class="action-group">
                                    <a href="{{ route('found-items.show', $foundItem) }}" class="btn-cancel">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="delete-warning">
                    ...
                    <div>
                        <p class="warning-title">Are you sure you want to delete this found item?</p>
            ...
            <div class="modal-footer">
                ...
                <form action="{{ route('found-items.destroy', $foundItem) }}" method="POST" style="display: inline;">
                    @csrf
                    @method('DELETE')
