...
<div class="page-header">
    <div class="page-title">
        <h1>
            <i class="fas fa-box-open text-success"></i> My Found Items
        </h1>
...
<div class="row mb-4">
    <div class="col-md-3">
        <div class="stats-card" style="background: linear-gradient(135deg, #3498db, #2980b9);">
            ...
            <div class="count">{{ $foundItems->total() }}</div>
    ...
    <div class="col-md-3">
        <div class="stats-card" style="background: linear-gradient(135deg, #f39c12, #e67e22);">
            ...
            <div class="count">{{ $foundItems->where('status', 'pending')->count() }}</div>
    ...
    <div class="col-md-3">
        <div class="stats-card" style="background: linear-gradient(135deg, #2ecc71, #27ae60);">
            ...
            <div class="count">{{ $foundItems->where('status', 'claimed')->count() }}</div>
    ...
    <div class="col-md-3">
        <div class="stats-card" style="background: linear-gradient(135deg, #e74c3c, #c0392b);">
            ...
            <div class="count">{{ $foundItems->where('status', 'disposed')->count() }}</div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group btn-group-sm">
                                ...
                                <a href="{{ route('found-items.edit', $item) }}" class="btn btn-outline-primary">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row g-2">
                            ...
                            <div class="col-6">
                                <small class="text-muted d-block">Lost Item:</small>
