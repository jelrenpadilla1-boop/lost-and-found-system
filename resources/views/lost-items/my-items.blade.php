...
@section('title', 'My Lost Items - Foundify')
...
<div class="dashboard-container">
    ...
    <div class="card table-card fade-in">
                        ...
                        <td data-label="Location">
                            @if($item->lost_location)
                                <span class="location-text" title="{{ $item->lost_location }}">
                                    ...
                                    {{ Str::limit($item->lost_location, 25) }}
                                </span>
        ...
        <div class="empty-state">
            ...
            <p>You haven't reported any lost items. Start by reporting your first lost item.</p>
            <a href="{{ route('lost-items.create') }}" class="btn btn-primary">
                <i class="fas fa-plus-circle"></i>
                Report Lost Item
            </a>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.data-table tbody tr').forEach(row => {
        ...
        const headers = ['Item', 'Category', 'Date Lost', 'Location', 'Status', 'Matches', 'Actions'];
