...
<div class="page-header">
    <div class="page-title">
        <h1>
            <i class="fas fa-box" style="color: var(--primary);"></i> My Lost Items
        </h1>
...
<div class="table-card">
    ...
    <div class="card-body">
        ...
        <div class="table-responsive">
            <table class="dark-table" id="lostItemsTable">
                <thead>
                    <tr>
                        <th>Item</th>
                        <th>Category</th>
                    ...
                    <tr>
                        ...
                        <td data-label="Actions">
                            <div class="action-buttons">
                                <a href="{{ route('lost-items.show', $item) }}" class="btn-icon view" title="View">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="{{ route('lost-items.edit', $item) }}" class="btn-icon edit" title="Edit">
        ...
        <div class="empty-state">
            ...
            <a href="{{ route('lost-items.create') }}" class="btn-primary">
                ...
                <div class="match-item-card">
                    ...
                    <div class="match-items">
                        <div class="match-item">
                            <small class="item-label">Your Item:</small>
                    ...
                    <div class="match-actions">
                        ...
                        <a href="{{ route('found-items.show', $match->foundItem) }}" class="btn-view-item">
