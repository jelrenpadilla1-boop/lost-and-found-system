...
<div class="page-header">
    <div class="page-title">
        <h1>
            <i class="fas fa-exclamation-circle text-danger"></i> Report Lost Item
        </h1>
...
<div class="row">
    <div class="col-lg-8 mx-auto">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror" 
                                          ...
                                          placeholder="Describe your lost item in detail (color, brand, serial number, distinguishing marks, etc.)" required>{{ old('description') }}</textarea>
                                <small class="text-muted">Detailed descriptions increase the chances of finding your item.</small>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control @error('date_lost') is-invalid @enderror" 
                                       id="date_lost" name="date_lost" value="{{ old('date_lost', date('Y-m-d')) }}" required>
                                @error('date_lost')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="card bg-light">
                                <div class="card-body">
                                    ...
                                    <p class="text-muted small mb-3">
                                        Providing the location where you lost the item helps our matching system find potential matches.
                                    </p>
        ...
        <div class="card mt-4">
            <div class="card-body">
                <h6 class="mb-3">
                    <i class="fas fa-lightbulb text-warning"></i> Tips for Finding Lost Items
                </h6>
                <ul class="list-unstyled mb-0">
                    <li class="mb-2"><i class="fas fa-check text-success me-2"></i> Report the loss as soon as possible</li>
                    <li class="mb-2"><i class="fas fa-check text-success me-2"></i> Provide clear photos if available</li>
                    <li class="mb-2"><i class="fas fa-check text-success me-2"></i> Include serial numbers or unique identifiers</li>
                    <li class="mb-2"><i class="fas fa-check text-success me-2"></i> Be specific about the location and time</li>
                    <li class="mb-0"><i class="fas fa-check text-success me-2"></i> Check your email regularly for match notifications</li>
                </ul>
            </div>
        </div>
    </div>
