...
<head>
    ...
    <style>
        * {
        ...
        .splash-content {
            text-align: center;
            animation: splashFadeIn 0.8s ease-out, splashScale 0.6s cubic-bezier(0.2, 0.9, 0.4, 1.1);
        }
        .splash-logo {
            font-size: 4rem;
            font-weight: 900;
        ...
        .splash-logo .logo-suffix {
            color: #ffffff;
        }
        body.light .splash-logo .logo-suffix {
            color: #1a1a1a;
        }
        .splash-tagline {
            margin-top: 1rem;
        ...
        /* Header, Hero, etc. (unchanged from original) */
        .header {
            position: fixed;
            top: 0;
            left: 0;
...
<div id="splash" class="splash-screen">
    <div class="splash-content">
        <div class="splash-logo">
            Found<span class="logo-suffix">ify</span>
        </div>
        <div class="splash-tagline">Reuniting what matters</div>
    </div>
</div>
...
<script>
    ...
    if (splash) {
        // Hide splash after 2.5 seconds with fade-out
        setTimeout(() => {
    ...
    // Fallback for already visible sections
    setTimeout(() => {
        document.querySelectorAll('.row-section, .stats-section, .cta-banner').forEach(el => {
